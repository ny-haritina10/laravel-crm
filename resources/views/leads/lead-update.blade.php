...
<head>
  ...
  <title>Update Lead Expense - New App</title>
              ...
              <div class="card-body">
                ...
                <form action="{{ route('dashboard.lead.update.submit', $lead['leadId']) }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="amount" name="amount" value="{{ $lead['expense']['amount'] ?? '' }}" required>
                  </div>
                  <div class="mb-3">
                    <label for="expenseDate" class="form-label">Expense Date</label>
                    <input type="date" class="form-control" id="expenseDate" name="expenseDate" value="{{ $lead['expense']['expenseDate'] ?? '' }}" required>
                  </div>
