...
<head>
  ...
  <title>Confirm Ticket Expense - New App</title>
      ...
      <main class="p-4">
        <div class="form-container">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="mb-4">
                <span class="ticket-id">Ticket #{{ $ticketId }}</span> - Expense Approval
              </h5>
              ...
              <div class="expense-alert">
                ...
                <div>
                  <h6 class="fw-bold">Budget Limit Exceeded</h6>
                  <p class="mb-0">The new expense will exceed your remaining budget. Please review and confirm.</p>
                </div>
              </div>
              ...
              <form action="{{ route('dashboard.ticket.confirm.submit', $ticketId) }}" method="POST">
                @csrf
                <input type="hidden" name="expenseDate" value="{{ $expenseDate }}">
                <input type="hidden" name="amount" value="{{ $amount }}">
                <div class="action-buttons">
                  <a href="{{ route('dashboard.tickets') }}" class="btn btn-cancel btn-action">
